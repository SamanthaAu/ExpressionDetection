...
x = np.load('./unimodalDataX.npy')
y = np.load('./unimodalLabels.npy')
...
# saving the training, validation, testing sets for future use
np.save('unimodalXtrain', X_train)
np.save('unimodalytrain', y_train)
np.save('unimodalXvalid', X_valid)
np.save('unimodalyvalid', y_valid)
np.save('unimodalXtest', X_test)
np.save('unimodalytest', y_test)
...
with open("unimodalModel.json", "w") as json_file:
    json_file.write(fer_json)
model.save_weights("unimodalModel.h5")
